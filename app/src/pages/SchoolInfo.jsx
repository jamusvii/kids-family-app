                            ...
                            {(info.notices || []).map(notice => (
                                <div key={notice.id} className="card notice-card">
                                    <div className="notice-header">
                                        ...
                                        <span className="notice-date">{notice.date} · {notice.source}</span>
                                    </div>
                ...
                {activeTab === 'rules' && (
                    <>
                        <section>
                            ...
                            <div className="card">
                                <p className="info-text">{info.morningActivity}</p>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="card">
                                <ul className="rule-list">
                                    {(info.schoolLifeRules || []).map((rule, i) => (
                                        <li key={i}>{rule}</li>
                                    ))}
                                </ul>
                            </div>
